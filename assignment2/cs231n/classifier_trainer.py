        ...
        for it in xrange(num_iters):
            ...
            for p in model:
                ...
                if update == 'sgd':
                    ...
                    #
                    v = self.step_cache[p]
                    dx = momentum * v - learning_rate * grads[p]
            ...
            if first_it or epoch_end or acc_check:
                ...
                if verbose:
                    varW1 = np.var(model['W1'])
                    varW2 = np.var(model['W2'])
                    print ('Finished epoch %d / %d: cost %f, train: %f, val %f, lr %e, varW1 %f, varW2 %f'
                           % (epoch, num_epochs, cost, train_acc, val_acc, learning_rate, varW1, varW2))
